...
from cert_prep_backend.domains.source_documents.adapters.windowsml import (  # noqa: E402
    device as windowsml_device,
    npu_prepass as windowsml_npu,
    runtime as windowsml,
)
from cert_prep_backend.domains.source_documents.adapters.windowsml.runtime import (  # noqa: E402
