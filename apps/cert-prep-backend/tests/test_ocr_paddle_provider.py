...
from cert_prep_backend.domains.source_documents.adapters.paddle_text import extract_prediction_text
...
def test_paddle_health_reports_cpu_fallback_when_cuda_unavailable(monkeypatch) -> None:
    import cert_prep_backend.domains.source_documents.adapters.paddle as paddle_module
