...
describe('CaptureUi', () => {
  ...
  beforeEach(() => { TestBed.configureTestingModule({ imports: [CaptureUi] }); fixture = TestBed.createComponent(CaptureUi); });
  ...
  it('processes a selected file through the adapter and emits canonical output', () => {
    ...
    const adapter: CaptureAdapter = { process: vi.fn(({ reportProgress }) => { reportProgress(50); return of(output); }) };
    ...
    const input = fixture.nativeElement.querySelector('input') as HTMLInputElement; Object.defineProperty(input, 'files', { value: [new File(['test'], 'scan.pdf', { type: 'application/pdf' })], configurable: true }); input.dispatchEvent(new Event('change')); TestBed.tick(); fixture.detectChanges();
  ...
  it('reports missing adapter as a per-file failure', () => {
    const failed = vi.fn(); fixture.componentInstance.failed.subscribe(failed); fixture.detectChanges();
    const input = fixture.nativeElement.querySelector('input') as HTMLInputElement; Object.defineProperty(input, 'files', { value: [new File(['x'], 'voice.wav')], configurable: true }); input.dispatchEvent(new Event('change')); TestBed.tick(); fixture.detectChanges();
